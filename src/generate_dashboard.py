...
INTEL_DATA_FALLBACK = [
    ...
    },
    {
        ...
        "summary": "TikTok @dental.park.clinic active มากที่สุดในกลุ่ม 'Dr.Park แม่แฝดหมอจัดฟัน' ภาษาอีสาน educational content ไม่ระบุราคาสาธารณะ",
        "source_url": "https://www.tiktok.com/@dental.park.clinic", "thumbnail_url": "",
        "tags": ["สกลนคร", "จัดฟัน", "TikTok", "ภาษาอีสาน", "educational"],
        "relevance": "high",
        "detail": "TikTok @dental.park.clinic active สูงสุดในกลุ่มคู่แข่ง ทพญ.พนิตนาฎ คงกระพันธ์ (ThaiOrtho certified) content เชิงลึก: จัดฟันร่วมกับผ่าตัดขากรรไกร ฟันสบคร่อม คางยื่น รุ่นใหญ่จัดฟัน Clear Aligner ล่าสุด 2026 ใช้ภาษาอีสาน 'บ่ได้ทำแค่จัดฟัน มาโลด!!!' สร้าง local connection สูง ไม่มี Instagram/Website/LINE OA",
        "pricing": {
        ...
        "strengths": ["TikTok content ดีสุดในกลุ่ม", "Brand identity ชัด (Dr.Park แม่แฝด)", "ภาษาอีสาน local connection สูง", "Educational content เชิงลึก", "ThaiOrtho certified"],
        "promotions": [],
        "weaknesses": ["ไม่พบราคาสาธารณะเลย", "ไม่มี Instagram", "ไม่มี LINE OA", "ไม่มี Website", "เวลาทำการสั้น (จ-ศ เพียง 16:30-20:00)"],
        "location": "1446/24 ถ.ยุวพัฒนา ต.ธาตุเชิงชุม อ.เมือง สกลนคร",
        "hours": "จ-ศ 16:30-20:00 / ส-อา+วันหยุด 09:00-16:00",
        "social_trend": {"primary_platform":"TikTok","posting_frequency":"สม่ำเสมอ","content_style":"educational","engagement_level":"high"}
    },
    {
        "id": "competitor-dio-dental",
        "category": "competitor",
        "title": "Dio Dental Clinic สกลนคร — ดีโอ้ เดนทัล",
        "summary": "Chain 21+ สาขา ISO 9001 จัดฟันใส 27,500 บาท รับบัตรทอง+ประกันสังคม Facebook 5,926 likes Slogan 'ดีโอ้ดีอะ'",
        "source_url": "https://diodental.com/branch/snk/", "thumbnail_url": "",
        "tags": ["สกลนคร", "Chain", "ISO9001", "บัตรทอง", "จัดฟันใส"],
        "relevance": "high",
        "detail": "Dio Dental สกลนคร Chain 21+ สาขาทั่วไทย ISO 9001 Facebook @diodentalsakhon ~5,926 likes รับบัตรทอง 30 บาท ประกันสังคม มี pricing page สาธารณะ: จัดฟันใส 27,500 บาท ขึ้นไป รากฟันเทียม ~23,999 บาท เปิด พฤ-อ 11:00-20:00 (ปิดวันพุธ) Facebook recommendation 100% (88 reviews)",
        "pricing": {
            "implant":{"price":"23999","note":"ราคาเริ่มต้น"},"braces_metal":{"price":"","note":"สอบถาม"},"braces_clear":{"price":"27500","note":"D-Smile เริ่มต้น"},
            "whitening":{"price":"","note":"สอบถาม"},"denture_full":{"price":"","note":""},"denture_partial":{"price":"","note":""},
            "veneer":{"price":"","note":""},"root_canal":{"price":"","note":""},"extraction":{"price":"","note":"ฟรีบัตรทอง"},
            "filling":{"price":"","note":"ฟรีบัตรทอง"},"scaling":{"price":"","note":"ฟรีบัตรทอง"},
            "other": [{"name": "จัดฟัน (ผ่อน)", "price": "999", "note": "ต่อเดือน (เงื่อนไขขึ้นกับแพ็กเกจ)"}]
        },
        "strengths": ["รับบัตรทอง+ประกันสังคม", "ISO 9001 มาตรฐานสากล", "Pricing page สาธารณะ", "Facebook recommendation 100%", "Brand recall สูง (ดีโอ้ดีอะ)", "21+ สาขา ความน่าเชื่อถือสูง"],
        "promotions": ["รับบัตรทอง 30 บาท", "รับประกันสังคม"],
        "weaknesses": ["Chain — ความรู้สึกส่วนตัวน้อย", "ปิดวันพุธ", "TikTok เป็น account กลาง ไม่ใช่ local"],
        "location": "1754/2 ซอย ถ.รัฐพัฒนา ต.ธาตุเชิงชุม สกลนคร",
        "hours": "พฤ-อ 11:00-20:00 (ปิดวันพุธ)",
        "social_trend": {"primary_platform":"Facebook","posting_frequency":"สม่ำเสมอ","content_style":"promotional","engagement_level":"medium"}
    },
    {
  ...
  <main id="main-content" class="flex-1 overflow-y-auto bg-slate-100 p-8">
    ...
    <div id="view-competitor-deep" class="view">
      ...
      <div class="flex flex-wrap gap-2 mb-6">
        ...
        <button class="intel-tab"        id="deep-tab-detail"    onclick="setDeepTab('detail')">🏥 รายคลินิก</button>
...
const COMPETITOR_EVENTS = [
  {{ date:'2026-05-18', competitor:'Dio Dental สกลนคร',  type:'new',      icon:'⚠️', text:'พบเป็นครั้งแรก — chain 21+ สาขาทั่วไทย ISO 9001 เข้าตลาดสกลนคร รากฟัน 23,999 บ. จัดฟันใส 27,500 บ.' }},
  {{ date:'2026-05-18', competitor:'B&B Dental',          type:'pricing',  icon:'💰', text:'ยืนยัน active พ.ค. 2026 โปรรีเทนเนอร์ 2,499 บาท TikTok @bb.dental.clinic3 โพสต์ล่าสุด พ.ค. 2026' }},
  {{ date:'2026-05-19', competitor:'หมอจั่นเจา',          type:'expand',   icon:'📍', text:'ยืนยัน 2 สาขาสกลนคร + 1 มุกดาหาร มี LINE OA @JUNJAO ระบบจองคิวออนไลน์ เปิดทุกวัน 10:00–20:00' }},
  {{ date:'2026-05-19', competitor:'Dental Park',          type:'content',  icon:'📱', text:'TikTok active — brand "Dr.Park แม่แฝดหมอจัดฟัน" content ภาษาอีสาน ไม่มี Instagram/Website/LINE OA' }},
  {{ date:'2026-05-19', competitor:'Toothmate',            type:'platform', icon:'📸', text:'ยืนยัน Instagram @toothmate_dc active (111 followers) หมอจบมหิดล+จุฬา มี Price list บนเว็บ' }},
  {{ date:'2026-05-19', competitor:'T Smile Dental',       type:'pricing',  icon:'💰', text:'ราคาโปร่งใส: รีเทนเนอร์ 2,990 บ. ฟอกสีฟัน 3,990 บ. Damon braces ผ่อน 0 บ.' }},
  {{ date:'2026-05-19', competitor:'คลินิกทันตกรรมสุภาวดี', type:'platform', icon:'📸', text:'Facebook + Instagram active จัดฟัน 35,000–40,000 บ. ผ่อนรายเดือน ไม่มีดอกเบี้ย' }},
];
...
function renderDeepDetail() {{
  ...
  el.innerHTML = '<div class="mb-5">'
    + '<label class="text-xs font-bold uppercase tracking-widest text-slate-500 mr-3">เลือกคลินิก</label>'
...
function renderDeepCompDetail() {{
  ...
  var priceRows = [];
  var pkeys = ['implant','braces_metal','braces_clear','whitening','denture_full','denture_partial','veneer','root_canal','extraction','filling','scaling'];
  var pLabels = {{'implant':'รากฟันเทียม','braces_metal':'จัดฟันโลหะ','braces_clear':'จัดฟันใส','whitening':'ฟอกสีฟัน','denture_full':'ฟันปลอมทั้งปาก','denture_partial':'ฟันปลอมบางส่วน','veneer':'วีเนียร์','root_canal':'รักษาราก','extraction':'ถอนฟัน','filling':'อุดฟัน','scaling':'ขูดหินปูน'}};
